export const experienceData = [
  {
    ...
    description:
      'Leading development of a scalable Next.js admin portal with Tailwind CSS, MUI, Redux Thunk, and Context API. Architecting backend services in NestJS with PostgreSQL, MongoDB, and Redis caching. Implementing OAuth 2.0 with Google login and RBAC for secure multi-role access. Built integrations with WooCommerce, GCP Excel reports, and SFTP CSV feeds to enable real-time content updates, decision-making dashboards, and streamlined document monitoring.',
  },
  {
  ...
  },
  {
    ...
    company: 'Priyam Innovations Pvt. Ltd.',
    description:
      'Implemented user forms with React controlled components, boosting data accuracy by 25% and reducing errors by 15%. Built responsive UI with React Suspense and CSS animations, ensured cross-browser compatibility, and contributed to PRs and bug fixes during CI/CD deployments.',
  },
];
